...
export function buildPrompt(input: {
  ...
  const lines = [
    ...
    "CRITICAL: Sound like a comedian on stage, not AI writing. Use conversational delivery.",
    voiceInstructions,
    "RHYTHM: Include setup → punch structure with natural comedian cadence.",
    "Examples: 'Man listen, X. Next thing I know, Y!' or 'You ever notice X? Yeah, Y.'",
    `Rating ${input.rating}:`,
